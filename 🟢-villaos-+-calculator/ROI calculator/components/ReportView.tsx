...
const ReportView: React.FC<ReportViewProps> = ({ data, inputs, isPrinting = false }) => {
  if (!data) {
    return (
  ...
  const showAdditionalCostsPage = inputs.enableAdditionalCosts && inputs.additionalCosts.length > 0; // Renamed
  const totalPages = 4 + (showAdditionalCostsPage ? 1 : 0);
  ...
  return (
    <div className="report-view-container">
      <main className="report-container">
        ...
        <section className="report-page">
          <header className="report-header">
            ...
            <div className="report-property-intro">
              <p className="report-date">Report elaborated on: {new Date().toLocaleDateString()}</p>
        ...
        <section className="report-page">
          <div className="report-content-section">
            ...
            <p className="sub-heading">Snapshot of Revenue, Operational Costs, and Operational Net Profit for the main strategy (first 10 years). Costs for additional expenditures impact cash flow directly, not these operational figures.</p>
             <div className="report-chart-container">
                <YearlyBreakdownChart data={chartProjectionsToDisplay} isForPdf={isPrinting} />
             </div>
          </div>
        ...
        {/* Page 3: Scenario Input Parameters */}
        <section className="report-page">
        ...
        {/* Page 4: 5-Year Exit Strategy (or alternative message) */}
        <section className="report-page">
        ...
        {/* Page 5: Additional Costs / Capital Expenditures Impact Analysis (Conditional) */}
